...
inputFile = LOAD 'hdfs:///user/m4project/episodeV_dialouges.txt' USING PigStorage('\t') AS (name:chararray,dial:chararray);
...
STORE cntd_desc INTO 'hdfs:///user/m4project/episodeV_results' USING PigStorage('\t');