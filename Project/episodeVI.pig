...
inputFile = LOAD 'hdfs:///user/m4project/episodeVI_dialouges.txt' USING PigStorage('\t') AS (name:chararray,dial:chararray);
...
STORE cntd_desc INTO 'hdfs:///user/m4project/episodeVI_results' USING PigStorage('\t');